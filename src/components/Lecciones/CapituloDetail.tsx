          ...
          return (
            <div key={pregunta.id} className="card border border-gray-200 dark:border-gray-700">
              ...
              <div className="mb-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700/30">
                ...
                <p className="mt-1 whitespace-pre-line text-sm text-gray-900 dark:text-white">
                  {pregunta.respuesta_de}
                </p>
                {pregunta.respuesta_es && (
                  <p className="mt-2 whitespace-pre-line text-xs italic text-gray-600 dark:text-gray-400">
                    {pregunta.respuesta_es}
                  </p>
                )}
